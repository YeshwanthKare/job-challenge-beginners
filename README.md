...
Il laboratorio è quindi pronto per cominciare la challenge!
...
# ESERCIZIO 4: installazione automatizzata di Prometheus e Grafana
...
![Dashboard risultato](./docs/img/dashboard.png)
